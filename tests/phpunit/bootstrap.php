...
define( 'CONFIGURE_SMTP_PLUGIN_DIR',  dirname( __FILE__, 3 ) );
define( 'CONFIGURE_SMTP_PLUGIN_FILE', CONFIGURE_SMTP_PLUGIN_DIR . '/configure-smtp.php' );

$polyfill_path = CONFIGURE_SMTP_PLUGIN_DIR . '/vendor/yoast/phpunit-polyfills/phpunitpolyfills-autoload.php';
...
function _manually_load_plugin() {
	require CONFIGURE_SMTP_PLUGIN_FILE;
}
